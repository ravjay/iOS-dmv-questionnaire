...
class QuestionBank{
    ...
    init() {
        list.append(Question(image: "flag1", questionText: "This British overseas territory is a popular tax haven.his British overseas territory is a popular tax haven.his British overseas territory is a popular tax haven.his British overseas territory is a popular tax haven.his British overseas territory is a popular tax haven.", choiceA: "A. Haiti khgkgh yif yfvygv yfyf fi f iyfiyfy fyyifyiyyiyfy his British overseas territory is a popular tax haven.", choiceB: "B. Suriname", choiceC: "C. Puerto Rico", choiceD: "D. Anguilla", answer: 4))
